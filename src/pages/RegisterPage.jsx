...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 relative overflow-hidden">
      {/* Harmonized decorative background shapes */}
          ...
          <div>
            ...
            <div className="relative group select-container">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-indigo-600 transition-colors">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M4.263 15.541A1.75 1.75 0 013.5 14H3a1 1 0 01-1-1V9a1 1 0 011-1h.5a1.75 1.75 0 011.637 1.132l1.312 3.565A1.75 1.75 0 018.086 14H12m-7.737 1.541A1.746 1.746 0 005.5 16h13a1.745 1.745 0 001.237-.459m-15.474 0a1.745 1.745 0 01-.263-1.541l1.312-3.565A1.75 1.75 0 016.95 9H17.05a1.75 1.75 0 011.637 1.132l1.312 3.565a1.75 1.75 0 01-1.637 2.303H4.263Z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full bg-slate-50/50 border border-slate-200 rounded-xl pl-11 pr-4 py-3 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all duration-200 focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-50 appearance-none cursor-pointer"
              >
